...
export const UMLStateFinalNodeC: FunctionComponent<Props> = ({ element, interactive, interactable, theme }) => {
  return (
    <g>
      <ThemedCircle
        cx="50%"
...
export const UMLStateFinalNodeComponent = enhance(UMLStateFinalNodeC);
