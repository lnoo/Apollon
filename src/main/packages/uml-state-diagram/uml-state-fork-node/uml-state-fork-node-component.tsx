...
const UMLStateForkNodeC: FunctionComponent<Props> = ({ element, interactive, interactable, theme }) => {
  return (
    <g>
      <ThemedRectContrast
...
export const UMLStateForkNodeComponent = enhance(UMLStateForkNodeC);
