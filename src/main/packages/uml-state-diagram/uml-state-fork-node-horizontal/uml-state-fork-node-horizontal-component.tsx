...
const UMLStateForkNodeHorizontalC: FunctionComponent<Props> = ({ element, interactive, interactable, theme }) => {
  return (
    <g>
      <ThemedRectContrast
...
export const UMLStateForkNodeHorizontalComponent = enhance(UMLStateForkNodeHorizontalC);
