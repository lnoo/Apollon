...
class ActivityObjectFlowUpdate extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <section>
          <Dropdown value={element.type as keyof typeof ActivityRelationshipType} onChange={this.onChange}>
            <Dropdown.Item value={ActivityRelationshipType.ActivityControlFlow}>
              {this.props.translate('packages.ActivityDiagram.ActivityControlFlow')}
            </Dropdown.Item>
            <Dropdown.Item value={ActivityRelationshipType.ActivityObjectFlow}>
              {this.props.translate('packages.ActivityDiagram.ActivityObjectFlow')}
            </Dropdown.Item>
          </Dropdown>
          <Divider />
  ...
  private onChange = (value: keyof typeof ActivityRelationshipType) => {
